...
class Backtesting:
    def __init__(self, data, strategy, initial_cash, max_holding_period, trading_fees):
    ...
    def get_performance_results(self):
        ...
        results = {
            'Start Trade Date': self.data['date'].iloc[0],
            'End Trade Date': self.data['date'].iloc[-1],
