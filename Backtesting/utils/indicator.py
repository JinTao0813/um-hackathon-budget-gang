...
class IndicatorCalculator:
    ...
    def add_ema(self, window: int, label: str = None):
    ...
    def add_sma(self, window: int, label: str = None):
    ...
    def add_volatility(self, window: int = 20):
    ...
    def add_rolling_volatility(self, window: int = 14):
        self.df['rolling_volatility'] = self.df['log_return'].rolling(window=window).std()
        return self

    def add_volume_stats(self, span: int = 14):
